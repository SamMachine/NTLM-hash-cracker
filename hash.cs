...
namespace Brute_Force
{
    class hash
    {
        ...
        public void isMatch(string check)
        {
            if (ntlm(check).Equals(this.ntlmHash))
            {
                Console.WriteLine();
                Console.WriteLine("Password found in " + this.time + " Hours, Minutes, Seconds!");
                Console.WriteLine("Your password is " + check);
                this.password = check;
                System.IO.File.WriteAllText(@"X:\Files\Programming\C# Programs\Brute_Force\Brute_Force\resource\BruteForce.txt", this.password);
                Console.WriteLine();
